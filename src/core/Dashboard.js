...
import FamilyTreeView from '../pages/family/FamilyTree';
import HomeView from '../pages/community/Home';
import ProfileView from '../pages/profile/Profile';
import SettingsView from '../pages/community/Settings';
import VolunteerView from '../pages/volunteer/Volunteer';

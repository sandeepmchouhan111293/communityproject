...
- generic [ref=e2]:
  - generic [ref=e3]:
      ...
      - list [ref=e23]:
        ...
        - listitem [ref=e42]:
          - button "Discussions" [ref=e43] [cursor=pointer]:
            ...
            - text: Discussions
        - listitem [ref=e45]:
          - button "Documents" [active] [ref=e46] [cursor=pointer]:
    ...
    - main [ref=e57]:
      - generic [ref=e58]:
        - heading "Community Documents" [level=1] [ref=e59]
        - button "Add Document" [ref=e60] [cursor=pointer]
        - paragraph [ref=e62]: No Documents Found
  - button "⬇️ Download Logs" [ref=e63] [cursor=pointer]
```